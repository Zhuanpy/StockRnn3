import pandas as pd
from App.code.MySql.LoadMysql import LoadNortFunds, LoadFundsAwkward
from App.code.MySql.DataBaseStockData15m import StockData15m
from App.code.MySql.DataBaseStockPool import TableStockPool, TableStockBoard, TableTradeRecord
from App.code.Signals.BollingerSignal import Bollinger
from App.code.Normal import MathematicalFormula as My_mfl
from App.code.Normal import StockCode
from App.code.MySql.sql_utils import Stocks
from App.code.parsers.BollingerParser import *
from matplotlib import pyplot as plt
from App.code.RnnModel.RnnRunModel import PredictionCommon
from App.code.TrendDistinguish.TrendDistinguishRunModel import TrendDistinguishModel

from sqlalchemy.exc import IntegrityError

from App.root_ import file_root
...
class ScoreStockPool(TrendDistinguishModel):
    ...
    def analysis_Industry(self):
        ...
        for index, row in poolB.iterrows():
            ...
            # 保存图片
            from App.code.RnnDataFile.stock_path import AnalysisDataPath
